...
Obr. 2 Propojení HW-827 s piny desky Arduino UNO (zdroj: DevXplained) ‎*(zdroj: web [DevXplained](https://devxplained.eu/en/blog/heart-rate-module-part-1))* ‎ ‎ ‎ ‎ ‎‎  ‎‎ ‎  Obr. 3 Propojení AD8232 s piny desky Arduino UNO (zdroj: )
