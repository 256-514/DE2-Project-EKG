...
/**
 * @file 
 * @defgroup fryza_timer Timer Libraary <timer.h>
...
/** @brief Set overflow 4ms, prescaler 001 --> 1 */
#define tim2_ovf_4ms() TCCR2B &= ~((1<<CS02) | (1<<CS01)); TCCR2B |= (1<<CS00);

/** @brief Set overflow 33ms, prescaler 010 --> 8 */
#define tim2_ovf_33ms() TCCR2B &= ~((1<<CS02) | (1<<CS00)); TCCR2B |= (1<<CS01);

/** @brief Set overflow 262ms, prescaler 011 --> 64 */
#define tim2_ovf_262ms() TCCR2B &= ~(1<<CS02); TCCR2B |= (1<<CS01) | (1<<CS00);

/** @brief Set overflow 1s, prescaler 100 --> 256 */
#define tim2_ovf_1sec() TCCR2B &= ~((1<<CS02) | (1<<CS01)); TCCR2B |= (1<<CS00);

/** @brief Set overflow 4s, prescaler // 101 --> 1024 */
#define tim2_ovf_4sec() TCCR2B &= ~(1<<CS02); TCCR2B |= (1<<CS00) | (1<<CS11);

/** @brief Enable overflow interrupt, 1 --> enable */
#define tim2_ovf_enable() TIMSK0 |= (1<<TOIE2);

/** @brief Disable overflow interrupt, 0 --> disable */
#define tim2_ovf_disable() TIMSK0 &= ~(1<<TOIE2);
